...
const Footer = () => {
  ...
  return (
    <footer>
      <menu className="menu">
        <button className="menu__item" style={{backgroundColor: "#ff8c00", display: "none"}}>
        ...
        <button className="menu__item" style={{backgroundColor: "#f54888", display: "none"}}>
          <svg className="icon" viewBox="0 0 24 24">
            <path
        ...
        <button onClick={() => clickLogout()} className="menu__item active" style={{backgroundColor: "#4343f5"}}>
          {/* <svg className="icon" viewBox="0 0 24 24">
        ...
        <button className="menu__item" style={{backgroundColor: "#e0b115", display: "none"}}>
          <svg className="icon" viewBox="0 0 24 24">
            <path
        ...
        <button className="menu__item" style={{backgroundColor: "#65ddb7", display: "none"}}>
          <svg className="icon" viewBox="0 0 24 24">
            <path
              d="M5.1,3.9h13.9c0.6,0,1.2,0.5,1.2,1.2v13.9c0,0.6-0.5,1.2-1.2,1.2H5.1c-0.6,0-1.2-0.5-1.2-1.2V5.1
                C3.9,4.4,4.4,3.9,5.1,3.9z"
